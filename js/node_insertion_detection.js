...
var css = '@keyframes nodeInserted{from{outline-color:#fff}to{outline-color:#000}}@-moz-keyframes nodeInserted{from{outline-color:#fff}to{outline-color:#000}}@-webkit-keyframes nodeInserted{from{outline-color:#fff}to{outline-color:#000}}@-ms-keyframes nodeInserted{from{outline-color:#fff}to{outline-color:#000}}@-o-keyframes nodeInserted{from{outline-color:#fff}to{outline-color:#000}}[data-timing],[data-load-timing]{-webkit-animation-name:nodeInserted;-moz-animation-name:nodeInserted;-ms-animation-name:nodeInserted;-o-animation-name:nodeInserted;animation-name:nodeInserted;-webkit-animation-duration:.001s;-moz-animation-duration:.001s;-ms-animation-duration:.001s;-o-animation-duration:.001s;animation-duration:.001s}';
...
var timingNodeInserted = function(event){
    if (event.animationName === 'nodeInserted') {
        ...
        var loadTimingName = event.target.getAttribute('data-load-timing');
        if (timingName) {
            console.timeEnd(timingName);
        }
        if (loadTimingName) {
            console.log('Time since load: ', loadTimingName, window.performance.now());
        }
    }
};
